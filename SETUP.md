...
You'll notice that "controlroom-bot" is scattered throughout the codebase. When
it comes time to modifying the code for your own purposes, you are expected to
replace every instance of "controlroom-bot" and its variances with your own
project's name.
...
```
controlroom-bot other-config.yaml
```
