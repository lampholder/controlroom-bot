...
version = exec_file(("controlroom_bot", "__init__.py"))["__version__"]
long_description = read_file(("README.md",))


setup(
    name="controlroom-bot",
    version=version,
    ...
    # Allow the user to run the bot with `controlroom-bot ...`
    scripts=["controlroom-bot"],
)
