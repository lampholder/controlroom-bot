...
The majority of the code is kept inside of the `controlroom_bot` folder, which
...
To run the bot, the `controlroom-bot` script in the root of the codebase is
